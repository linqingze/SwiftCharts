...
public struct ChartAxisValuesStaticGenerator {
    ...
    /**
     ...
     - returns: An array of axis values.
     */
    public static func generateYAxisValuesWithChartPoints(_ chartPoints: [ChartPoint], start:Double, minSegmentCount: Double, maxSegmentCount: Double, multiple: Double = 10, axisValueGenerator: ChartAxisValueStaticGenerator, addPaddingSegmentIfEdge: Bool) -> [ChartAxisValue] {
        return generateAxisValuesWithChartPoints(chartPoints, start: start, minSegmentCount: minSegmentCount, maxSegmentCount: maxSegmentCount, multiple: multiple, axisValueGenerator: axisValueGenerator, addPaddingSegmentIfEdge: addPaddingSegmentIfEdge, axisPicker: {$0.y})
    }
    ...
    fileprivate static func generateAxisValuesWithChartPoints(_ chartPoints: [ChartPoint],start:Double , minSegmentCount: Double, maxSegmentCount: Double, multiple: Double = 10, axisValueGenerator: ChartAxisValueStaticGenerator, addPaddingSegmentIfEdge: Bool, axisPicker: (ChartPoint) -> ChartAxisValue) -> [ChartAxisValue] {
        ...
        if let last = sortedChartPoints.last {
            return generateAxisValuesWithChartPoints(start, last: axisPicker(last).scalar, minSegmentCount: minSegmentCount, maxSegmentCount: maxSegmentCount, multiple: multiple, axisValueGenerator: axisValueGenerator, addPaddingSegmentIfEdge: addPaddingSegmentIfEdge)
